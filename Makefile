...
OBJS_PARMAKE=parmake.o parser.o rule.o parmake_main.o format.o serial.o

# set up compiler
CC = gcc
WARNINGS = -Wall -Wextra -Werror -Wno-error=unused-parameter
INC=-I./includes/
CFLAGS_DEBUG   = -O0 $(WARNINGS) $(INC) -g -std=c99 -c -MMD -MP -D_GNU_SOURCE -pthread -fopenmp -DDEBUG
CFLAGS_RELEASE = -O2 $(WARNINGS) $(INC) -g -std=c99 -c -MMD -MP -D_GNU_SOURCE -pthread -fopenmp
...
# set up linker
LD = gcc
LDFLAGS = -pthread -fopenmp -Llibs/ -lprovided
